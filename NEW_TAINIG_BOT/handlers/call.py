...
async def process_weight_loss_goal(message: types.Message, state: FSMContext):
    ...
    if weight_loss_goal == '1':
        ...
        with_muscles = int(bmr + 500 - 300)    # С сохранением мышц
        ...
        await message.reply("Ваш вариант дефицита калорий: " + str(optimal_loss) + '  Это медленное и оптимальное похудение')
